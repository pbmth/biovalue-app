...
def load_data():
    try:
        ...
        # Varukoopia näidisandmetega
        data = {
            'Brand': ['BudgetHealth', 'Thorne', 'California Gold'],
            'Form': ['Oxide', 'Bisglycinate', 'Citrate'],
            'Unit_Type': ['Capsule', 'Capsule', 'Gram'],
            'Price_Bottle': [12.00, 48.00, 20.00],
            'Shipping': [4.00, 0.00, 0.00],
            'Units_Total': [120, 60, 283],
            'Mg_per_Unit': [500, 200, 140],
            'Yield_Coeff': [0.60, 1.0, 1.0],
            'Absorb_Coeff': [0.04, 0.45, 0.25],
            'Notes': ['Pure Oxide', '+ B6 & Vitamin C', 'Pure Powder'],
...
st.write("---")
st.caption("PPAA = Price Per Actually Absorbed milligram. This reveals the true cost of nutrients.")
